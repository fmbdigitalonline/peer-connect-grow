  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        peer: {
          purple: "hsl(var(--peer-purple))",
          'purple-dark': "hsl(var(--peer-purple-dark))",
          'purple-light': "hsl(var(--peer-purple-light))",
          magenta: "hsl(var(--peer-magenta))",
          orange: "hsl(var(--peer-orange))",
          red: "hsl(var(--peer-red))",
          green: "hsl(var(--peer-green))",
          lime: "hsl(var(--peer-lime))",
